...
{
    private static int editDistanceMax=TERRA.SPELLDISTANCE;
    private static int verbose = 0;
    //0: top suggestion
    //1: all suggestions of smallest edit distance 
    //2: all suggestions <= editDistanceMax (slower, no early termination)

    public SymSpell(String[] all){
    	CreateDictionary(all, "");
    }
    ...
    private static void CreateDictionary(String[] all, String language)
    {
    	
        System.out.println("Setting up SymSpell Checker...");
        ...
        System.out.println("\rSpell Checker: " + wordCount + " words, " + dictionary.size() + " entries, edit distance=" + editDistanceMax + " in " + (endTime-startTime)+"ms ");
